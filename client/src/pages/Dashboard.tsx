...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (user?.perfil === "cobrador") {
      setLocation("/cobrador");
      return;
    }

    // Admin carrega estatísticas
      ...
      <main className="container py-8">
        ...
        {stats && (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
            <Card>
              <CardHeader className="pb-3"><CardTitle>Total Usuários</CardTitle></CardHeader>
              <CardContent><div className="text-3xl font-bold text-primary">{stats.totais.usuarios}</div></CardContent>
            </Card>

            <Card>
              <CardHeader className="pb-3"><CardTitle>Passageiros</CardTitle></CardHeader>
              <CardContent><div className="text-3xl font-bold text-primary">{stats.totais.passageiros}</div></CardContent>
            </Card>

            <Card>
              <CardHeader className="pb-3"><CardTitle>Viagens Hoje</CardTitle></CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-3"><CardTitle>Receita Hoje</CardTitle></CardHeader>
              <CardContent><div className="text-3xl font-bold text-secondary">R$ {stats.hoje.receita.toFixed(2)}</div></CardContent>
            </Card>
          </div>
        )}
      </main>
